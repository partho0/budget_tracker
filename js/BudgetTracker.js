export default class BudgetTracker {
    ...
    static entryHtml() {
        return `
         <tr>
                    <td>
                        <input class="input input-date" type="date"></input>
                    </td>
                    <td>
                        <input class="input input-description" type="text" placeholder="add a description"></input>
                    </td>
                    <td>
    ...
    load() {
        const entries = JSON.parse(localStorage.getItem("budget-tracker-dev") || "[]");
    ...
    save() {
        ...
        localStorage.setItem("budget-tracker-dev", JSON.stringify(data));
        this.updateSummary();
    }
